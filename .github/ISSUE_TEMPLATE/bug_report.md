...
<!-- REPLACE THIS COMMENT with a thorough summary of the issue as you understand it after investigation:
- Root cause analysis
- Affected components, files, and systems
- Impact assessment (who is affected and how severely)
- Any related issues or dependencies discovered
-->

### Phase 2: Solution Options

- [ ] **Develop 1-3 solution options**
...
- Specific code changes at a high level
- Order of operations
-->
